...
<th> delete</th>
 ...
 <tr>
 	...
 	<td><img src="<?php echo base_url(); ?>our_result/<?php echo $r['photo_name']?>" height="60" width="100">
<br><?php echo $r['photo_name'] ?></td>
 	<td><?php print anchor('deleteourresult/'.$r['id'].'/delete', 'Delete', array('onclick'=>'return confirmation()')); ?></td>
